    ...
    <footer>
      <div className="main-cont">
        ...
        <div className="footer-cont-contact">
          <div className="footer-icon-subscribe">
          ...
          <div className="social-media">
            <a
              target="_blank"
              href="https://www.facebook.com/Rossodiromacr"
            ...
            <a
              target="_blank"
              href="https://www.instagram.com/rossodiromacr/?hl=es"
              rel="noopener noreferrer"
            >
              <svg
                stroke="currentColor"
      ...
      <div className="last-cont">
        <div className="linea-long"></div>
        <div className="translator">
          <h2>Traducir</h2>
          <p>© 2024 Rosso di Roma. Derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
